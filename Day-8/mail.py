...
app.title("Email Sent")
heading = Label(text="Email App", bg="yellow", fg="black", font="10", width="500", height="3")
heading.pack()
...
button = Button(app, text="Send Message", command=send_message, width="30", height="2", bg="gray")
